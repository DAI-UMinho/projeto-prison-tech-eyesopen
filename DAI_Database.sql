...
create table Login (idPessoa int, username nvarchar(30), password varBinary(256), accessLevel nvarchar(30), primary key (idPessoa), foreign key (idPessoa) references Pessoa (id))
